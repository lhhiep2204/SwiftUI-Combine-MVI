...
extension BLEManager {
    ...
    func startScan(withServices serviceUUIDs: [CBUUID]? = nil ) {
        ...
        self.center?.scanForPeripherals(withServices: serviceUUIDs,
    ...
    func connect(peripheral: CBPeripheral) {
        ...
        self.center?.connect(peripheral, options: nil)
    }
    
    func disconnect(peripheral: CBPeripheral) {
        print("BLEManager disconnect \(peripheral.identifier.uuidString)")
        self.center?.cancelPeripheralConnection(peripheral)
    }
...
extension BLEManager: CBCentralManagerDelegate {
    ...
    func centralManager(_ central: CBCentralManager,
        ...
        self.delegate?.bleManager(didDiscover: peripheral)
    }
    ...
    func centralManager(_ central: CBCentralManager,
        ...
        self.delegate?.bleManager(didConnect: peripheral)
    }
    ...
    func centralManager(_ central: CBCentralManager,
        ...
        self.delegate?.bleManager(didFailToConnect: peripheral, error: error)
    }
    ...
    func centralManager(_ central: CBCentralManager,
        ...
        self.delegate?.bleManager(didDisconnectPeripheral: peripheral, error: error)
    }
...
extension BLEManager: CBPeripheralDelegate {
    ...
    func peripheral(_ peripheral: CBPeripheral,
        ...
        self.delegate?.bleManager(peripheral, didUpdateValueFor: characteristic, error: error)
    }
